...
\begin{figure}[!t]
	\begin{center}
		...
		{
			\label{fig:nt5}
			\includegraphics[width=0.45\columnwidth]{Figures/nt5}
		} 
		\subfigure[Expected energy consumption]
		{
			\label{fig:ne5}
			\includegraphics[width=0.45\columnwidth]{Figures/ne5}
		} 
	\end{center}
	%\vskip -0.22in 
...
\begin{figure}[!t]
	\begin{center}
		...
		{
			\label{fig:nt25}
			\includegraphics[width=0.45\columnwidth]{Figures/nt25}
		} 
		\subfigure[Expected energy consumption]
		{
			\label{fig:ne25}
			\includegraphics[width=0.45\columnwidth]{Figures/ne25}
		} 
	\end{center}
	%\vskip -0.22in 
