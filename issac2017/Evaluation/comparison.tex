...
\begin{figure}[!t]
	\begin{center}
		...
		{
			\label{fig:f3}
			\includegraphics[width=0.45\columnwidth]{Figures/f3}
		} 
		\subfigure[Expected completion time]
		{
			\label{fig:t31}
			\includegraphics[width=0.45\columnwidth]{Figures/t31}
		} 
		\subfigure[Expected completion time with checkpointing removed]
		{
			\label{fig:t32}
			\includegraphics[width=0.45\columnwidth]{Figures/t32}
		} 
		\subfigure[Expected energy consumption with checkpointing removed]
		{
			\label{fig:e32}
			\includegraphics[width=0.45\columnwidth]{Figures/e32}
		} 
	\end{center}
	%\vskip -0.22in 
