...
Currently there are two fault tolerance approaches. %, both of which fail to answer the question above. 
...
%The rest of the statement is organized as follows. Section~\ref{sec:progress} introduces current progress and presents our preliminary results. Section~\ref{sec:future} points out directions for future exploration. Section~\ref{sec:conclusion} concludes this statement.
