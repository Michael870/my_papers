...
\date{September, 2016} % This date is the date of the thesis defense. Default is \today
\year{2016}   % pittetd will use the current year unless otherwise indicated. So this command is not necessary.
...
\committeemember{Dr. Taieb Znati, Department of Computer Science, University of Pittsburgh}
