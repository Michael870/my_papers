...
consumption, both being direct consequences of the increase in the number of components~\cite{exa_challenge_2010}. 
...
technique to conserve power, increases the probability of transient faults~\cite{chandra2008defect}. The trade-off between fault free operation and 
...
I have studied different techniques to embody and augment the model, and developed analytical frameworks for different objectives in the Cloud and HPC environments~\cite{cui_en7085151,cui_2016_scalcom,cui_2014_closer}.
...
To complete my thesis, I propose to continue the study in two aspects.
...
costs under strict completion time constraints~\cite{cui_en7085151,cui_2014_closer}. 
