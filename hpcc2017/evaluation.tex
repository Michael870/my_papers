...
\begin{figure}[!t]
	\begin{center}
		...
		\subfigure[HPCCG weak scalability]
		{
			...
			\includegraphics[width=0.9\columnwidth]{figures/hpccg_weak}
		}
		...
		{
			\label{fig:comd_weak}
			\includegraphics[width=0.9\columnwidth]{figures/comd_weak}
		}
	\end{center}
	\vskip -0.2in
      ...
      \subfigure[Wall-clock execution time]
		{
			...
			\includegraphics[width=0.9\columnwidth]{figures/failures_time}
		}
		\subfigure[Weighted execution time]
		{
			\label{fig:failures_ntime}
			\includegraphics[width=0.9\columnwidth]{figures/failures_ntime}
		}
  \end{center}
  \vskip -0.2in
