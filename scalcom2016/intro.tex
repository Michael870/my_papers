...
approach, each process (referred to as a \textit{main}) is associated with a ``lazy" replica (referred to as a \textit{shadow}) to improve resilience. %The shadow executes the same code as its
