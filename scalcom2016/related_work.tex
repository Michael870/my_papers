...
in the case of a failure, computation can be restarted from recently saved state. % \cite{Elnozahy:02:Survey}. %The identification of an error, before or during a checkpoint,
...
As a result,
replication has recently been proposed to addresses the deficiencies of checkpointing in HPC \cite{Cappello:09:Fault,engelmann2011redundant}. 
Full and partial
