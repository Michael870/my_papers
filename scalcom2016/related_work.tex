...
Rollback and recovery is the dominate mechanism to achieve fault
...
This approach is baredly used in HPC systems, primarily due to its high cost and low efficiency.
However, upcoming extreme-scale systems are expected to require a more challenging level of fault tolerance to deal with the grow in both frequency and diversity of faults.
As a result,
